...
//Java_com_myhexaville_androidwebrtc_OpencvActivity_ConvertRGBtoGray(JNIEnv *env, jobject instance,
//                                                                   jlong matAddrInput,
//                                                                   jlong matAddrResult) {
//
...
Java_com_myhexaville_androidwebrtc_OpencvActivity_loadCascade(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_myhexaville_androidwebrtc_OpencvActivity_detect(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_myhexaville_androidwebrtc_tutorial_MediaStreamActivity_loadCascade(JNIEnv *env,
                                                                            jobject instance,
                                                                            jstring cascadeFileName_) {
    //const char *cascadeFileName = env->GetStringUTFChars(cascadeFileName_, 0);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_myhexaville_androidwebrtc_tutorial_MediaStreamActivity_detect(JNIEnv *env,
                                                                       jobject instance,
                                                                       jlong cascadeClassifier_face,
                                                                       jlong cascadeClassifier_eye,
                                                                       jlong matAddrInput,
