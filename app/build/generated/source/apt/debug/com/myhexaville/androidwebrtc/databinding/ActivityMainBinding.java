...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    @NonNull
    public final android.widget.TextView roomEdittext;
    @NonNull
    public final android.widget.ImageView xBtn;
    // variables
    // values
    // listeners
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.roomEdittext = (android.widget.TextView) bindings[2];
        this.xBtn = (android.widget.ImageView) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
